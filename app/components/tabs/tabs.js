angular.module('app.tabs', ['ngMaterial', 'ngMessages'])
  ...
  function ($scope, $log) {
    var tabs = [
      {title: 'Grabbit', content: "Tabs will become paginated if there isn't enough room for them."},
      {title: 'Arcade', content: "You can swipe left and right on a mobile device to change tabs."},
      {
        title: 'Esports',
